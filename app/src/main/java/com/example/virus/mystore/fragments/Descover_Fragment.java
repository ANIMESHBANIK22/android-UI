...
public class Descover_Fragment extends Fragment {
    View root;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.fragment_descover_, container, false);
        dataListRecycler();
        return root;
    }
    ...
    private void dataListRecycler(){
        ...
        sub_item_List.add(new Sub_Details("Jenney Karmin","Alobha Technologies"));
        sub_item_List.add(new Sub_Details("Jenney Karmin","Alobha Technologies"));
        sub_item_List.add(new Sub_Details("Jenney Karmin","Alobha Technologies"));
        sub_item_List.add(new Sub_Details("Jenney Karmin","Alobha Technologies"));
        sub_item_List.add(new Sub_Details("Jenney Karmin","Alobha Technologies"));
