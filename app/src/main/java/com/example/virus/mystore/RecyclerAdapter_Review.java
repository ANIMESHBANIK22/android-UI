...
public class RecyclerAdapter_Review extends RecyclerView.Adapter<RecyclerAdapter_Review.ViewHolder> {

    private Context context;
    private List<YourCart_Model> yourCart_models;

    public RecyclerAdapter_Review(Context context, List yourCart_models) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.review_items, parent, false);
